...
const ContactUs = () => {
    ...
    return (
        <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            ...
            <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
                ...
                <div>
                    ...
                    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                        ...
                        <input name="email" type="email" placeholder='Enter your email id' className='w-full p-3 text-sm outline-none' required />
                    </div>
                </div>
