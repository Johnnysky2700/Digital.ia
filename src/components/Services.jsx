...
const Services = () => {
    ...
    const servicesData = [
        ...
        },
        {
            ...
            description: 'We help you excute your plan and deviler results.',
    ...
    return (
     ...
     pt-30 text-gray-700 dark:text-white'>
            ...
            <Title title='How can we help?' desc='From strategy to execution, we craft digital solutions that move
