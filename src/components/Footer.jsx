        ...
        <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
            ...
            <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
                ...
                <div className='text-gray-600 dark:text-gray-400'>
                    ...
                    <p className='text-sm mt-2 mb-6'>Stay updated with our latest news and updates.</p>
                    <div className='flex gap-2 text-sm'>
                        <input type="email" placeholder='Enter your email id' className='w-full p-3 text-sm
                        outline-none rounded dark:gray-200 bg-transparent border border-gray-300 dark:border-gray-500' />
            ...
            <hr className='border-gray-300 dark:border-gray-600 my-6'/>
             ...
             <div className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
                <p>Copyright 2025 © Johnnysky - All rights reserved.</p>
