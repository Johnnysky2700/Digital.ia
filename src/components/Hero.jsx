...
const Hero = () => {
    ...
    w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        max-w-5xl'>Turning imagination into <span className='bg-gradient-to-r from-[#5044E5] to-[#4D8CEA]
        bg-clip-text text-transparent'>digital</span> impact.</motion.h1>
            ...
            initial={{opacity: 0, y: 30}}
                ...
                viewport={{ once: true }}
            className='text-sm sm:text-lg font-medium text-gray-500 dark:gray-500 dark:text-white/75
        max-w-4/5 sm:max-lg pb-3'>Creating meaningful connections and turning big ideas into <br />
                interactive digital experiences.</motion.p>
